...
<body>
    ...
    <!-- Marquee 
    <marquee style="font-weight: bold; color: #333; margin-top: 10px;">This is a library management system. Library opens at 8:00 AM and closes at 8:00 PM.</marquee>
    -->

    <!-- Category Table -->
    <div class="container mt-4">
        <center><h4>Registered Book Categories</h4></center>
